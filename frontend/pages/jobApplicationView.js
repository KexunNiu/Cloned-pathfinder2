...
function JobApplicationView({jobData, setReRender}) {
  ...
  return (
    ...
    <img className='w-2/3 h-64 ml-10' src={jobData.job.opportunity_picture ? host+jobData.job.opportunity_picture : '../../defaultOpp.png'} />
        <h3 className="mb-2 font-bold tracking-tight text-gray-500 dark:text-gray">Name: {jobData.job.job_title}</h3>
        <h3 className="mb-2 font-bold tracking-tight text-gray-500 dark:text-gray">Description: {jobData.job.job_description}</h3>
        <h5 className="mb-2 font-bold tracking-tight text-gray-900 dark:text-black">Application#: {jobData.applicants.length}</h5>
